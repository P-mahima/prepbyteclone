const fullstack = require("../model/FullStack");
...
const addProducts = async (req, res) => {
    try {
      const data = req.body;
      const newData = await fullstack.create(data);
  ...
  const addProductsToDb = async (req, res) => {
    ...
    const Result = await fullstack.create({
      no,
      title,
      image,
      date,
  ...
  const fetchData = async (req, res) => {
    const data = req.body;
    const result = await fullstack.find();
    return res.send({ Result: result });
  };
  
  const deleteProd = async (req, res) => {
    const data = req.body;
    const result = await fullstack.deleteMany();
